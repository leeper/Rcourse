...
\begin{center}
\only<1>{\includegraphics[width=\textwidth]{figure/rpop_listserv.png}}
\only<2>{\includegraphics[height=.85\textheight]{figure/rpop_forum.png}}
%\only<3>{\includegraphics[width=\textwidth]{figure/rpop_so.png}}
%\only<4>{\includegraphics[height=.85\textheight]{figure/rpop_survey.png}}
%\only<5>{\includegraphics[height=.85\textheight]{figure/rpop_books.png}}
\only<6>{\includegraphics[width=\textwidth]{figure/rpop_gs.png}}
\only<7>{\includegraphics[height=.85\textheight]{figure/rpop_links.png}}
\end{center}
}
...
\frame{
\begin{center}
%\only<1>{\includegraphics[height=\textheight]{figure/tufte-cancer-survival-plot.pdf}}
\only<1>{\includegraphics[height=\textheight]{figure/bootstrap_lm_fits.png}}
\only<2>{\includegraphics[height=\textheight]{figure/german_unemployment.png}}
\only<3>{\includegraphics[width=\textwidth]{figure/nominate.png}}
\only<4>{\includegraphics[width=\textwidth]{figure/nyt_govt_control.png}}
\only<5>{\includegraphics[width=\textwidth]{figure/playervalue.png}}
\end{center}
}
\egroup
